    ...
    <div className="md:grid md:grid-cols-2">
      <div className="md:py-[60px] lg:py-[60px] lg:pl-20 lg:pr-20 sm:hidden md:flex">
        ...
        <img
          src={data.image}
          alt="image"
          className="lg:block w-full min-h-full hidden"
        />
      </div>
      <div className="px-6 py-8 md:py-[60px] lg:max-w-[710px] flex flex-col justify-between gap-40">
        <div className="flex flex-col gap-4">
          <div className="font-medium font-cabin text-[24px] leading-[26.88px] text-brand-500 md:text-[31px] md:leading-[34.72px] lg:text-[33px] lg:leading-[36.96px]">
            {data.title}
          </div>
          <div className="font-normal font-lato text-[16px] leading-[24px] text-[#7d89b0] md:text-[18px] md:leading-[27px] lg:text-[19px] lg:leading-[28.5px]">
            {data.description}
          </div>
        </div>
